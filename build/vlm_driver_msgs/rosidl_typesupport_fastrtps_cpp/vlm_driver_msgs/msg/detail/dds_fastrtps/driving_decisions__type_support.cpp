...
#include "vlm_driver_msgs/msg/detail/driving_decisions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const vlm_driver_msgs::msg::DrivingDecisions & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.steering_label;
  // Member: speed_label
  cdr << ros_message.speed_label;
  // Member: steering_deg
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vlm_driver_msgs::msg::DrivingDecisions & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_vlm_driver_msgs
max_serialized_size_DrivingDecisions(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vlm_driver_msgs::msg::DrivingDecisions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vlm_driver_msgs::msg::DrivingDecisions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vlm_driver_msgs::msg::DrivingDecisions *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DrivingDecisions__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const vlm_driver_msgs::msg::DrivingDecisions *>(
...
static size_t _DrivingDecisions__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DrivingDecisions(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DrivingDecisions__callbacks = {
  "vlm_driver_msgs::msg",
  "DrivingDecisions",
...
static rosidl_message_type_support_t _DrivingDecisions__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DrivingDecisions__callbacks,
...
{
  return &vlm_driver_msgs::msg::typesupport_fastrtps_cpp::_DrivingDecisions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vlm_driver_msgs, msg, DrivingDecisions)() {
  return &vlm_driver_msgs::msg::typesupport_fastrtps_cpp::_DrivingDecisions__handle;
}
