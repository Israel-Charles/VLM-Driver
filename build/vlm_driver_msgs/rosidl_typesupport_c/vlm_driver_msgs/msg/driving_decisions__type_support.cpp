...
static const _DrivingDecisions_type_support_symbol_names_t _DrivingDecisions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vlm_driver_msgs, msg, DrivingDecisions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vlm_driver_msgs, msg, DrivingDecisions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vlm_driver_msgs, msg, DrivingDecisions)() {
  return &::vlm_driver_msgs::msg::rosidl_typesupport_c::DrivingDecisions_message_type_support_handle;
}
