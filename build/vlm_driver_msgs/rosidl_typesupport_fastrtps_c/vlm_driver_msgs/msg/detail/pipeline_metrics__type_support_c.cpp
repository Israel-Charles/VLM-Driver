...
#include "vlm_driver_msgs/msg/detail/pipeline_metrics__rosidl_typesupport_fastrtps_c.h"
...
using _PipelineMetrics__ros_msg_type = vlm_driver_msgs__msg__PipelineMetrics;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PipelineMetrics__ros_msg_type * ros_message = static_cast<const _PipelineMetrics__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: preprocess_ms
  {
    cdr << ros_message->preprocess_ms;
  }

  // Field name: decision_ms
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PipelineMetrics__ros_msg_type * ros_message = static_cast<_PipelineMetrics__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_vlm_driver_msgs__msg__PipelineMetrics(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PipelineMetrics__ros_msg_type * ros_message = static_cast<const _PipelineMetrics__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PipelineMetrics__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_vlm_driver_msgs__msg__PipelineMetrics(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_vlm_driver_msgs
size_t max_serialized_size_vlm_driver_msgs__msg__PipelineMetrics(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = vlm_driver_msgs__msg__PipelineMetrics;
    is_plain =
      (
...
static size_t _PipelineMetrics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_vlm_driver_msgs__msg__PipelineMetrics(
...
static message_type_support_callbacks_t __callbacks_PipelineMetrics = {
  "vlm_driver_msgs::msg",
  "PipelineMetrics",
...
static rosidl_message_type_support_t _PipelineMetrics__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PipelineMetrics,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vlm_driver_msgs, msg, PipelineMetrics)() {
  return &_PipelineMetrics__type_support;
}
